    ...
    <header className={cn(
      ...
      <div className="container flex h-20 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            className="flex items-center justify-center rounded-full p-2.5 md:hidden hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
      ...
      {/* Mobile Menu Overlay */}
      {isMenuOpen && (
        <div className="fixed inset-0 top-20 z-50 bg-background md:hidden overflow-y-auto">
